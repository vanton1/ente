...
- Current release documentation must distinguish source compatibility from
  distributed state. The updated fork builds successfully, but its quarantined
  debug/Simulator artifacts do not supersede Firebase Android build 2159 or iOS
  build 2161 until a separate higher-numbered release is prepared and accepted.
